...
import { CheckCircle, XCircle, RotateCcw, BarChart2, Home } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="px-4 pt-5 pb-28 space-y-4 overflow-y-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
          ...
          {parentTopic && (
            <p className="text-xs text-gray-400 mt-0.5">{parentTopic.name}</p>
          )}
          ...
          <div className="border-t border-gray-100 pt-4">
            ...
            <div className="grid grid-cols-3 gap-2 text-center">
              ...
              <div>
                <p className="text-xl font-black text-gray-700">{formatTime(avgSeconds)}</p>
                <p className="text-[11px] text-gray-400 mt-0.5">Avg Time</p>
              </div>
            </div>
          </div>
        </div>
