...
// Issue #1 + #9 fix: include /practice/session and /practice/summary so
// BottomNav is hidden during the entire practice flow (session + summary).
const HIDE_NAV_PATHS = ['/exam/session', '/practice/session', '/practice/summary', '/onboarding'];
...
// Issue #6 fix: wrap Layout in an ErrorBoundary so corrupt localStorage state
// cannot crash the entire app to a blank white screen.
