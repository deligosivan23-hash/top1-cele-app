...
export const useStore = create(
  persist(
    (set, get) => {
      // Bug #8 fix: build seed data inside the factory, not at module level.
      // This prevents re-generating timestamps on every module import, which
      // could cause subtle seed-data inconsistencies before the first persist flush.
